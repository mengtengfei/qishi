        ...
        <div class="head clearfix">
            ...
            <div class="topLeft left">
                <a href="index.html" title="Darry Ring">
                    <img width="186" height="42" src="/home/images/logo_01.png ">
                </a>
                <span>求婚钻戒领导品牌</span>
            </div>
            <!--头部左边end-->
                ...
                <div class="cr_border">
                    ...
                    <div style="display:none" class="photo_show">
                        ...
                        <!--其他合作end-->
                         ...
                         <div><span style="font-size: 12px; display: inline-block;padding-top: 10px;float:left;margin-left: 176px; ">已经有账号，</span><span style="color: #8e4f1b; font-size: 12px; display: inline-block; float: right; margin-right: 42px; padding-top: 10px;"><a href="/login">立即登录</a></span></div>
                    <!--邮箱注册end-->
                </div>
                <!--登陆框内end-->
            </div>
...
<script src="/hoyyme/js/jquery.js" type="text/javascript"></script>
