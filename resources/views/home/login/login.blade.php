   ...
   <div class="head_top"> 
    <div class="head clearfix"> 
     ...
     <div class="topLeft left"> 
      <a href="index.html" title="Darry Ring"> <img width="186" height="42" src="/home/images/logo_01.png " /> </a> 
      <span>求婚钻戒领导品牌</span> 
     </div> 
     <!--头部左边end--> 
     <!--头部右边--> 
     ...
     <div class="cort-right right"> 
      ...
      <form method="post" action="/login/create" id="loginform"> 
       <div class="cr_border"> 
        ...
        <a href="/register"><span class="left">注册</span> </a>
          <!-- <span class="right focus">登录</span>  -->
          <input type="submit" id="d" class="right focus" value="登录">
         </div> 
        </div> 
        <!--按钮end--> 
        <!--其他合作--> 
